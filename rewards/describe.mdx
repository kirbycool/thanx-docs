---
title: "Describe Rewards"
description: "This endpoint returns a user's rewards."
api: "GET /rewards"
---

Rewards are available in several different states: - available => This reward is
`available` to use - `active` => The user has activated this reward for use -
`used` => The reward has been used

### Parameters

<ParamField body="states" type="array[string]">
